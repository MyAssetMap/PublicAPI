...
// }
//
// function getSuperUsers(callback) {
...
// }
//
// function getUserByEmail(emailAddress, callback) {
...
// }
//
// function loginUpdate(userID, callback) {
//   updateRow("User", "lastLogin", 'TODAY()', "id", userID, callback)
// }
//
// function getUserPayload(userID, callback) {
//   var isActive,
//     superID = [],
//     accountID = [],
//     mapID = [];
...
// }
//
// function createUser(UUID, firstName, lastName, callback) {
...
// }
//
// function createUserGroup(payload, callback) {
...
// }
//
// function deleteUserGroup(groupID, callback) {
//
...
// }
//
// function createLayer(payload, callback) {
//     //Create Group First
//   var label = payload.label;
...
// }
//
// function setupLayer(payload, groupID, callback) {
//
//   //Group
//   var userID = payload.userID;
//   if (userID == null) return callback(true, 'User ID (`userID`) must be supplied.');
...
// }
//
// function setupSubLayers(layerID, type, callback) {
...
// }
//
// function updateLayerOrder(userID, order, deleteGroups, callback) {
//
...
// }
//
// function deleteLayer(groupID, callback) {
//
...
// function getAccountsSuperByUserID(userID, callback) {getTableWhere('SuperUser','userID',userID,callback)}
//
// //TODO:CREATE FUNCTION FOR THIS
// //with userID get account the user belongs.
// function getAccountsByUserID(userID, callback) {getRowFromTableWhere('AccountUser','accountID','userID',userID,callback)}
//
// function getMapsByAccountID(accountID, callback) {getRowFromTableWhere('Map','id','accountID',accountID,callback)}
//
// function getGroupByID(currentKey, groupID, callback) {
//   var finalReturn = [];
//
//   getTableWhere('LayerGroup','id',groupID,function(error,groups) {
...
// }
//
// function getGlobalLayers(mapID, callback) {
//   var finalReturn = [];
//
...
// }
//
// function getLayers(mapID, userID, callback) {
//   var finalReturn = {};
//
//   getRowFromTableWhere('User',['userLayers'],'id',userID,function(error,users) {
//     if (error) return callback(true, users);
...
// // ==========
//
// function runQuery(queryMsg, callback) {
...
// }
//
// function getRowFromTable(table, row, callback) {
//   runQuery('SELECT ' + fromSingleValueToValues(row,'"') + ' FROM public."' + table + '"', callback);
// }
//
// function getTableWhere(table, fieldName, value, callback) {
...
// }
//
// function getRowFromTableWhere(table, row, fieldName, value, callback) {
//   if (!Array.isArray(value)) {
...
// }
//
// function getInnerJoin(fields, firstTable, firstIdentifier, secondTable, secondIdentifier, callback) {
...
// }
//
// function updateRow(table, column, value, identifierColumn, identifier, callback) {
//   runQuery('UPDATE public."' + table + '" SET "' + column + '" = ' + processValue(value) + ' WHERE "' + identifierColumn + '" = \'' + identifier + '\';', callback);
// }
//
// function appendToJSONRow(table, column, value, identifierColumn, identifier, callback) {
//   runQuery('UPDATE public."' + table + '" SET "' + column + '" = "' + column + '"::jsonb || '+processValue(value)+'::jsonb WHERE "' + identifierColumn + '" = \'' + identifier + '\';', callback);
// }
//
// function deleteFromJSONRow(table, column, value, identifierColumn, identifier, callback) {
//   runQuery('UPDATE public."' + table + '" SET "' + column + '" = "' + column + '"::jsonb || '+processValue(value)+'::jsonb WHERE "' + identifierColumn + '" = \'' + identifier + '\';', callback);
// }
//
// function insertRow(table, columns, values, callback) {
...
// }
//
// function deleteTableWhere(table, fieldName, value, callback) {
//   if (!Array.isArray(value)) {
...
// }
//
// function processValue(value,char) {
...
// }
//
// function fromSingleValueToValues(valuesOrValues,char) {
//   if (typeof char === 'undefined') char = `'`;
//
